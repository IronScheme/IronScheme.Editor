...
namespace WeifenLuo.WinFormsUI
{
	...
	{
    static readonly System.Collections.ArrayList ALL = new System.Collections.ArrayList();

    internal static IDockContent Get(string pstr)
    {
      foreach (DockContent dc in ALL)
      {
        if (dc.Text == pstr)
        {
          return dc;
