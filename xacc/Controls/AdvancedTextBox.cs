...
namespace Xacc.Controls 
{
  ...
  public partial class AdvancedTextBox : Control, IEdit, IFile, IEditSpecial, IEditAdvanced, INavigate, IScroll, IHasCodeModel, IFind
    ...
    //clamp value (15 - 100)
		static SolidBrush selbrush = Factory.SolidBrush(Color.FromArgb(Math.Max(15, Math.Min(100, -50 + (int)(SystemColors.Highlight.GetBrightness() * 200))), SystemColors.Highlight));
		Pen selpen = Factory.Pen(selbrush.Color, 1);
