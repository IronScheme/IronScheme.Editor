  ...
  **************************************************************/
  public  class CLexGen 
  {
      ...
      )
    {
      ...
      if (null == m_instream)
      {
        Console.Error.WriteLine("Error: Unable to open input file "
          + filename + ".");
        return;
      }
      ...
      if (null == m_outstream)
      {
        Console.Error.WriteLine("Error: Unable to open output file "
          + filename + ".cs.");
        return;
      }
      ...
      m_spec.inputfilename = Path.GetFullPath(filename);
      ...
      )
    {
      ...
      if (m_spec.m_verbose)
      {
        System.Console.WriteLine("Processing second section -- CSLex declarations.");
      }
      userDeclare();
      if (m_input.m_eof_reached)
      {
      ...
      )
    {
      ...
      action_index = m_input.m_line_index;
