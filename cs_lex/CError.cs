...
namespace CS_Lex
{
  ...
  *******************************************************/
  public class CError 
  {
    ...
    {
      Console.Error.WriteLine("JLex Error: " + message);
    }
    ...
    {
      Console.Error.WriteLine("Error: Parse error at line " + line_number + ".");
      Console.Error.WriteLine("Description: " + errmsg[error_code]);
