...
auxforms               ="rename"|"except"|"only"|"else"|"=>"|"mutable"|"immutable"|"fields"|"nongenerative"|"parent"|"protocol"|"sealed"|"opaque"|"parent-rtd"|"..."|"_"|"prefix"
...
baseprocs2             ="call/cc"|"call-wit-current-continuation"|"memv"|"assv"|"memq"|"assq"|"assoc"|"member"|"void"|"boolean?"|"number?"|"char?"|"cadr"|"cddr"|"newline"|"display"|"read"|"write"|"make-parameter"|"time-it"
baseprocs3             ="+"|"-"|"*"|"/"|"length"|"vector-length"|"="|"vector-set!"|"<="|"<"|">"|">="|"integer->char"|"char->integer"|"for-each"|"char<=?"|"string->list"|"symbol->string"|"procedure?"
baseprocs4             ="string-append"|"string?"|"with-input-from-file"|"with-output-from-file"|"dynamic-wind"|"list->vector"|"make-vector"|"vector->list"|"string->symbol"|"gensym"|"symbol?"|"environment?"
...
<ML_STRING>\\         { return String(STRING); }
...
"library"             { return Keyword(LIBRARY); }
"import"              { return Keyword(IMPORT); }
"export"              { return Keyword(EXPORT); }

"define"              { return Keyword(DEFINE); }
"define-syntax"       { return Keyword(DEFINESYNTAX); }
